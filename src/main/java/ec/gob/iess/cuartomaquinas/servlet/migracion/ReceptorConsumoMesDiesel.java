...
/**
 * Servlet implementation class ReceptorConsumoMesDiesel
 */
@WebServlet("/ReceptorConsumoMesDiesel")
public class ReceptorConsumoMesDiesel extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReceptorConsumoMesDiesel() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		StringBuffer jb = new StringBuffer();
		  ...
		  Boolean res = manejadorDiesel.guardarRegistrosConsumoMesDiesel(lista);
		  if (!res) {
