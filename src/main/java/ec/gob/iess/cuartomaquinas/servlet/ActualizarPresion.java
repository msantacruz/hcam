 ...
 */
@WebServlet("/ActualizarPresion")
public class ActualizarPresion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActualizarPresion() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PresionFlujoDTO presionFlujoDTO = manejadorPresionConstante.buscarUltimoValor();
		
		response.getWriter().write(new Gson().toJson(presionFlujoDTO));
